...
function StaBadge({ s }: { s: string }) {
  ...
  return (
    <span style={{ 
      ...
      fontWeight:600, 
      whiteSpace:"nowrap",
      transition: "background 0.35s cubic-bezier(0.4, 0, 0.2, 1), color 0.35s cubic-bezier(0.4, 0, 0.2, 1), border-color 0.35s cubic-bezier(0.4, 0, 0.2, 1), box-shadow 0.35s cubic-bezier(0.4, 0, 0.2, 1)"
    }}>
      <span style={{ 
        width:7, 
        height:7, 
              ...
              {STATUS_FLOW.map((s, i) => {
                ...
                return (
                  <div key={s} style={{ 
                    ...
                    padding:"8px 12px", 
                    borderRadius:10, 
                    background: cur ? cfg.bg : done ? (currentTheme === "dark" ? "#0F172A" : "#F8F9FA") : C.card, 
                    border:`1.5px solid ${cur ? cfg.dot : C.borderLight}`,
                    transform: cur ? "scale(1.01) translateX(4px)" : "scale(1) translateX(0)",
                    boxShadow: cur ? "0 4px 12px rgba(0,0,0,0.04)" : "none",
                    ...
                    <div style={{ 
                      ...
                      height:20, 
                      borderRadius:"50%", 
                      background: done ? C.green : cur ? cfg.dot : C.border, 
                      display:"flex", 
                      alignItems:"center", 
                      justifyContent:"center", 
                      flexShrink:0,
                      position: "relative",
                      transition: "background-color 0.4s cubic-bezier(0.4, 0, 0.2, 1), background 0.4s cubic-bezier(0.4, 0, 0.2, 1)"
                    }}>
                      <span style={{ 
                        color:"#fff", 
                        fontSize:11, 
                      ...
                      <span style={{ 
                        ...
                        position: "absolute",
                        opacity: cur ? 1 : 0, 
                        transform: cur ? "scale(1)" : "scale(0.5)", 
                        transition: "opacity 0.35s ease, transform 0.35s cubic-bezier(0.34, 1.56, 0.64, 1)" 
                      }} />
                    </div>
                    <span style={{ 
                      ...
                      color: cur ? cfg.color : done ? C.textSub : C.textMuted,
                    ...
                    <div style={{ 
                      ...
                      alignItems: "center",
                      opacity: cur ? 1 : 0,
                      transform: cur ? "scale(1)" : "scale(0.8)",
                      transition: "opacity 0.4s cubic-bezier(0.4, 0, 0.2, 1), transform 0.4s cubic-bezier(0.4, 0, 0.2, 1)",
                      pointerEvents: cur ? "auto" : "none"
                    }}>
                      <span style={{ fontSize:10, background:cfg.bg, color:cfg.color, padding:"2px 7px", borderRadius:8, fontWeight:700 }}>NOW</span>
                    </div>
                  </div>
                );
              })}
...
export default function App() {
  ...
  if (!portal) {
    return <PortalSelector onSelect={p => { setPortal(p); setView(p==="staff"?"requests":"incoming"); }} office={office} setOffice={setOffice} theme={theme} toggleTheme={toggleTheme} />;
  }
